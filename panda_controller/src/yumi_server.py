...
class Yumi_PicknPlace:
    ...
    def move_to_goal(self, req):
        ...
        #Should add default position or at least move right arm out of the way
        # Publish joint states of perch position
        #perch_pos = [-0.025947508262960033, -1.0964866571830743, -0.7983558137697956, 0.5955203215216464, -2.596306302958593, -0.7268574890097599, 1.9696674614784746, 0.3383778027292554, -1.0321237461622943, 0.7971025395672604, 0.46552729376200475, -0.039228572055155, 1.3029963490195122, 0.6332093576874375, 0.0, 0.0, 0.0, 0.0]
